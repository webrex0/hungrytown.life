document.getElementById('icForm').addEventListener('submit', function(event) {
    ...
    if (age >= 53 && age <= 62) {
        categoryRows.innerHTML += `<tr><td>Age 53-62</td><td>${formattedData.N4},${formattedData.Y3},${formattedData.Y4}</td></tr>`;
    }
    if (age >= 63 && age <= 72) {
        categoryRows.innerHTML += `<tr><td>Age 63-72</td><td>${formattedData.Y4},${formattedData.Y1},${formattedData.Y2}</td></tr>`;
    }
    ...
    newCategoryRows.innerHTML += `<tr><td>Age 33-42</td><td>${formattedData.D2},${formattedData.N1},${formattedData.N2}</td></tr>`;
    newCategoryRows.innerHTML += `<tr><td>Age 43-52</td><td>${formattedData.N2},${formattedData.N3},${formattedData.N4}</td></tr>`;
    newCategoryRows.innerHTML += `<tr><td>Age 53-62</td><td>${formattedData.N4},${formattedData.Y3},${formattedData.Y4}</td></tr>`;
    newCategoryRows.innerHTML += `<tr><td>Age 63-72</td><td>${formattedData.Y4},${formattedData.Y1},${formattedData.Y2}</td></tr>`;
